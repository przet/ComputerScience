...
(* Homework2(SELFMADE) Tests *)

use "hw2_selfMade.sml";

(* Tests for Question 1 *)
val Q1test1 = is_older ((1,2,3),(2,3,4)) = true (* a simple, initial test *)
val Q1test2 = is_older ((1,2,3),(1,2,3)) = false 
...
(* Tests for Question 3a *)
val Q3atest1 = number_in_months2 ([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[2,3,4]) = 3
val Q3atest2 = number_in_months2
([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[8,11,10]) = 0
val Q3atest3 = number_in_months2 ([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[2,3]) = 2
val Q3atest4 = number_in_months2
([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[2,3,1,12,8,9]) = 3
(*
